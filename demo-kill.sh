...
docker exec -i "$container_id" /opt/couchbase/bin/cbc-pillowfight -U couchbase://localhost/travel-sample -u Administrator -P password -r 95 -m 51200 -M 10240000 -I 1000000 
