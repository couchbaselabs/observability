...
The Cluster Monitor can be installed as a binary (`.rpm`), or by downloading a Docker image.

**Binary installation**

_Binary installation steps.... .rpm just install using package manager?..._
