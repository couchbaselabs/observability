...
If you don't have any existing Couchbase cluster installed then you can install it from https://docs.couchbase.com/server/current/install/getting-started-docker.html#section_jvt_zvj_42b[here^].
