...
You can further read on prometheus configuration on the https://prometheus.io/docs/prometheus/latest/configuration/configuration/[official documentation website^].
...
You may also create additional dashboards that meets your needs.
...
It will show a list of dashboards similar to the one below. You can navigate to each dashboard by clicking on the name.
