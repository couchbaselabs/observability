...
Once you are in, navigate to the Configuration option on the left sidebar menu and select Data Sources, then click Add Data Source.
Select Prometheus as your first data source and configure it for the Prometheus we started earlier:

// TODO: image goes here

Perform the same steps to add Loki:

// TODO: image goes here

_Add in note about Grafana declarative provisioning._
