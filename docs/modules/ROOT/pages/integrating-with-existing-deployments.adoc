...
See xref:tutorial-standalone.adoc#_install_cluster_monitor[Install Cluster Monitor] on how to run the Cluster Monitor and configure it to discover your Prometheus and Alertmanager instances.
