...
See our xref:tutorial-standalone.html#_install_prometheus[Install Prometheus] documentation for an example of what this file should look like with an appropriate Couchbase Server `scrape_config`.

=== Install Prometheus Alerting Rules

Follow the Standalone tutorial instructions on xref:tutorial-standalone.html#_prometheus_alerting_rules[Installing Prometheus Alerting rules].

== Alertmanager

=== Downloading and installing Alert templates

Follow the instructions in the xref:tutorial-standalone.html#_prometheus_alerting_rules[Standalone example guide].
