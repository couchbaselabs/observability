...
[abstract]
== Introduction
Integration of CMOS with your current monitoring pipelines can be achieved through configuration of existing Prometheus, Alertmanager, and Grafana instances
