...
*Condition*: A DCP rollback to zero is seen in the `memcached` logs.

*Remediation*: This is typically a symptom of another problem, you should your cluster closely for any further issues.
