...
*Further Reading*: https://docs.couchbase.com/server/current/metrics-reference/data-service-metrics.html#kv_ep_storage_age_seconds, https://docs.couchbase.com/server/current/install/sizing-general.html#sizing-data-service-nodes
