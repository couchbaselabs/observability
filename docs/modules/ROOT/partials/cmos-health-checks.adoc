...
*Background*: A service has been forced to roll back to zero. This is bad because it means the service is attempting to resynchronize the entirety of the data set.
