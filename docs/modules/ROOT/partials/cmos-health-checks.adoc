...
*Condition*: If the time in seconds since the most recently stored object was initially queued is over 50 seconds a warning is produced, and upgraded to critical if the time is over 100 seconds.
