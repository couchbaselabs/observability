...
*Background*: Having items in the disk write queue for a long time can cause backoffs.

*Condition*: Age of items in disk write queue over 2 seconds.

*Remediation*: Contact Couchbase Technical Support.

*Further Reading*: https://docs.couchbase.com/server/current/metrics-reference/data-service-metrics.html#kv_ep_storage_age_seconds
