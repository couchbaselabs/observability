...
*Background*: More then 50% of the memory is occupied by document keys and other metadata, this can happen when the document keys are large, or there are many small documents.
