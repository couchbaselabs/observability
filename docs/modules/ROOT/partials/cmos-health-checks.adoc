...
[#CB90067]
=== Service Has Been Forced to Roll Back to Zero (CB90067)

*Background*: A service has been forced to roll back to zero. This is bad because it means the service is attempting to resynchronise the entirety of the data set.

*Condition*: a rollback is seen in the `memcached` logs.
