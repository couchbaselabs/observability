...
set -ex
# For envsubst we have to export - all these should already be set by run.sh
...
PROMETHEUS_STORAGE_MAX_SIZE=${PROMETHEUS_STORAGE_MAX_SIZE:-30GB}
PROMETHEUS_RETENTION_TIME=${PROMETHEUS_RETENTION_TIME:-90d}
