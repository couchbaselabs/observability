...
done < <(find "${SCRIPT_DIR}/.." -type d -path "*/go" -prune -o -type d -path "*/tools/bats" -prune -o -type d -path "*/bats" -prune -o -type d -path "*/tools/tern" -prune -o -type f \( -name '*.sh' -o -name '*.bash' -o -name '*.bats' \) -print0)
